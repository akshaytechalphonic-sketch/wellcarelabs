...
<head>
    <meta charset="utf-8" />
    <title>Recover Password | WellCare Admin</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Password recovery — WellCare Admin" />
    ...
    <style>
      ...
      .form-control:focus {
        ...
        box-shadow: 0 0 0 3px rgba(51,178,123,0.12);
      }
      ...
      .btn-primary.custom {
        ...
        padding: 0.8rem;
        border-radius: 8px;
        box-shadow: 0 8px 24px rgba(22,66,66,0.08);
        transition: all 0.25s ease;
      }

      .btn-primary.custom:hover {
        transform: translateY(-1px);
        box-shadow: 0 10px 26px rgba(22,66,66,0.12);
      }
...
<body>
                    ...
                    <div class="recover-card">
                        <div class="text-center">
                            <a class='auth-logo' href="{{ url('/') }}" aria-label="WellCare home">
                                <img src="{{ asset('assets/images/wellcare_logo.png') }}" alt="WellCare Labs logo" />
                            </a>
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.email') }}" class="my-3" id="recoverForm" novalidate>
                            @csrf
                            ...
                            <div class="form-group mb-0">
                                <div class="d-grid">
                                    <button class="btn btn-primary custom" type="submit" id="recoverBtn">Recover Password</button>
                                </div>
                            </div>
                        </form>
    ...
    <script>
      ...
      (function(){
        ...
        // focus first invalid field if server returned errors
        @if ($errors->any())
          (function(){
