...
<div class="admin-page-wrapper">
    <div class="card shadow-sm form-card">
        ...
        <div class="card-header d-flex justify-content-between align-items-center bg-white border-bottom py-3">
            <div>
                <h5 class="panel-title mb-0">Add Testimonial</h5>
                <small class="text-muted">Create a new review to display on the homepage</small>
            </div>
            <div>
            ...
            <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="name" id="name" required class="form-control form-control-pill @error('name') is-invalid @enderror" placeholder="e.g. Ravi Ranjan" value="{{ old('name') }}">
                        @error('name')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="designation" id="designation" class="form-control form-control-pill @error('designation') is-invalid @enderror" placeholder="e.g. Patient, Doctor, Business Partner" value="{{ old('designation') }}">
                        @error('designation')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="url" name="video_url" id="video_url" class="form-control form-control-pill @error('video_url') is-invalid @enderror" placeholder="e.g. https://www.youtube.com/watch?v=VIDEO_ID" value="{{ old('video_url') }}">
                ...
                <div class="row">
                    {{-- Avatar File --}}
                    <div class="col-md-6 mb-3">
                        <label for="image" class="field-label">User Avatar / Profile Photo</label>
                        ...
                        <div id="avatarPreviewContainer" class="mt-3" style="display:none;">
                            <img id="avatarPreview" src="#" alt="Preview" style="max-width:100px;border-radius:50%;object-fit:cover;height:100px;border:2px solid #e2e8f0;">
                        </div>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="review" id="review" required rows="6" class="form-control form-control-pill @error('review') is-invalid @enderror" placeholder="Write patient testimonial review text here...">{{ old('review') }}</textarea>
                    @error('review')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
