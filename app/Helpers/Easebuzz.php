<?php
   namespace App\Helpers;
    ...
    class Easebuzz{
       ...
       /*private $MERCHANT_KEY = "45B7RW0Y7";
        private $SALT = "1UVFWYY1Z";
        private $ENV = "test";*/
        
        private $MERCHANT_KEY = "2PF95TGIFI";
        private $SALT = "ASDOSRIR3N";
        private $ENV = "test";
        ...
        */
        ...
        function __construct($key, $salt, $env){
            ...
            $this->SALT = $salt;
            $this->ENV = $env;
            //require_once APPPATH . 'Libraries/Payment.php';
        }
        ...
        */
        public function initiatePaymentAPI($params, $redirect=True){
          // echo "<pre>";print_r($params);die;
            ...
            // $params['txnid'] = $txnid;
            return $this->initiate_payment($params, $redirect, $this->MERCHANT_KEY, $this->SALT, $this->ENV);
        }
